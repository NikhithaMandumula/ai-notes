      ...
      <div className="min-h-screen flex items-center justify-center px-4 relative z-10 overflow-hidden">
        <div className="w-full max-w-md relative z-10">
          ...
          <div className="relative">
            ...
            <div className="relative bg-[var(--card-bg)] backdrop-blur-2xl rounded-[20px] shadow-[0_0_50px_rgba(96,165,250,0.15),0_16px_48px_rgba(0,0,0,0.15)] p-8 text-center">
              ...
              <p className="text-sm font-medium text-blue-400 mb-4">{submittedEmail}</p>
              <p className="text-xs text-[var(--text-muted)] mb-6">
                Click the link in the email to verify your account. The link expires in 24 hours.
              </p>
              <Link
                to="/login"
                className="inline-block w-full py-3 text-sm font-medium text-white bg-gradient-to-r from-cyan-400 via-blue-400 to-blue-500 rounded-[14px] shadow-[0_0_20px_rgba(96,165,250,0.25)] hover:shadow-[0_0_30px_rgba(96,165,250,0.45)] transition-all duration-500 text-center"
              >
                Go to Sign In
              </Link>
            </div>
